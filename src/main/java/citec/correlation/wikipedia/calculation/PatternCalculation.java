...
public class PatternCalculation implements PatternThresold{
    ...
    private Map<String, List<ResultDetail>> patternEntities = new TreeMap<String, List<ResultDetail>>();
        ...
        //for (EntityResults entities : entityResults) {
            ...
            for (WordResult wordResults : entities.getDistributions()) {
                ...
                if (patternEntities.containsKey(key)) {
                    ...
                    propertyObjects = new ArrayList<ResultDetail>();
                }
    ...
    public Map<String, List<ResultDetail>> getPatternEntities() {
